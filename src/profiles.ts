...
const REAL_PROFILES: Profile[] = [
  ...
  },
  {
    ...
    emoji: "🥩",
    short: "best steaks",
    kicker: "the world's best steak restaurants, year by year 🥩",
    titleMain: "world's best",
    titleEm: "steaks",
    docTitle: "world's best steaks 🥩",
    bio: "worldbeststeaks.com's annual 101 best steak restaurants — 2022, 2024, 2025 & 2026 editions on one map. one pin per restaurant; filter by year to watch the ranking shift, from basque asadores to dry-aged temples.",
    dataUrl: "data/world/worldbeststeaks.geojson",
    camera: { center: [8, 32], zoom: 1.6, spin: true },
    shows: [
      { id: "Y2026", name: "2026 edition", short: "2026", network: "worldbeststeaks.com", color: "#d12631", emoji: "🥩" },
      { id: "Y2025", name: "2025 edition", short: "2025", network: "worldbeststeaks.com", color: "#e8823a", emoji: "🥩" },
      { id: "Y2024", name: "2024 edition", short: "2024", network: "worldbeststeaks.com", color: "#cda52e", emoji: "🥩" },
      { id: "Y2022", name: "2022 edition", short: "2022", network: "worldbeststeaks.com", color: "#7f93a6", emoji: "🥩" },
    ],
    labels: EN_LABELS,
    footerQuote: "fire, salt, and a great cut.",
    footerNote: "unofficial · annual lists from worldbeststeaks.com (2024–2026; 2022 & earlier via the Wayback Machine) · pins forward-geocoded",
    mapService: "google",
    group: "award",
  },
];
